...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div onClick={() => {
        ...
        }} className="flex w-full p-4 mb-2 border-white border-2 active:border-black rounded-xl items-center justify-between">
          ...
          <div className="w-1/2">
            <h4 className="text-base font-medium">UberGo <span><i className="ri-user-line font-semibold"></i>4</span></h4>
        ...
        <div onClick={() => {
          ...
          <div className="w-1/2">
            <h4 className="text-base font-medium">Moto <span><i className="ri-user-line font-semibold"></i>1</span></h4>
        ...
        <div onClick={() => {
          ...
          <div className="w-1/2">
            <h4 className="text-base font-medium">UberAuto <span><i className="ri-user-line font-semibold"></i>1</span></h4>
            <h5 className="text-sm font-medium">2 min away</h5>
